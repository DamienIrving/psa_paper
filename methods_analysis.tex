...
The general data analysis techniques described below are the same as those employed in the zonal wave analysis of \citet{IrvingSimmonds2015} and the following text is derived from there with minor modifications.
